...
public class MainActivity extends Activity {
    public String sGameActivity = "uk.lgl.modmenu.MainActivity2";
    //url para seu canal no youtube - URL YOUTUBE CHANEL
    public String sUrl = "https://www.youtube.com/c";
    public String consulta = "http://lurching-hinge.000webhostapp.com/";
    public String sUser = "";
...
// nao modifique os nomes dos edtext e buttoon
    ...
    private void SetupForm() {
        ...
        teamName.setBackgroundColor(Color.parseColor("#ff1f2b3f"));
        ...
        note.setGravity(1);
        note.setBackgroundColor(Color.parseColor("#ff1f2b3f"));
        ...
        userTextView.setBackgroundColor(Color.parseColor("#ff1f2b3f"));
        ...
        passTextView.setBackgroundColor(Color.parseColor("#ff1f2b3f"));
        ...
        footerText.setText(Html.fromHtml("<font face='monospace'>Tela de login by Hyupai Mods <font color='#ffff00'>   Clique aqui para consultar validade!</font></font>"));
        footerText.setTextColor(Color.parseColor("#00ff00"));
        footerText.setGravity(17);
        footerText.setTextSize(17.0f);
        footerText.setBackgroundColor(Color.parseColor("#ff1f2b3f"));
        ...
        footerText.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MainActivity.this.startActivity(new Intent("android.intent.action.VIEW", Uri.parse(consulta + "consulta.php")));
            }
        });
        ...
        scrollView.setBackgroundColor(Color.parseColor("#ff1f2b3f"));
        ...
        desc.setBackgroundColor(Color.parseColor("#ff1f2b3f"));
